...
public class BillSort {
	...
	public BillSort(String id, String billDate, Category category,
	...
	public BillSort(String billDate, Category category,
			String createOn, String description, String dueDate,
			boolean isRecurring, List<Itemlist> items, String lastUpdatedOn,
			int status, Vendor vendor,int amount,RecurringSetting recurringSetting) {
		super();
	...
	public BillSort(String billDate, int amount,String dueDate) {
		super();
		this.billDate = billDate;
		this.dueDate = dueDate;
		this.amount = amount;
